...
const Explore = () => {
	...
	const fetchCryptoData = useCallback(async () => {
		const res = await fetch('https://interim-assesment-michelleadams89.onrender.com/api/crypto');
	...
	return (
		<div className="min-h-screen flex flex-col bg-white pt-32 md:pt-[144px]">
			<Navbar />
